...
class Permission:
    ...
    async def __call__(self, token: str = Header(...)):
        ...
        try:
            ...
            user_info = AtsResponse.model_to_dict(user, "password")
...
#
#
# class AtsRouter(object):
#     """
#     ats路由基类，支持单标crud
#     """
#
#     def __init__(self, group: str, schema: AtsModel = None, path: str = "", read: int = Config.MEMBER,
